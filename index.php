...
<head>
	<title>Portfolio-Itthikorn</title>
	<meta charset="utf-8">
			...
			<div class="hero-wrap js-fullheight" style="background-image: url(images/bg_1.jpg);" data-stellar-background-ratio="0.5">
				...
				<div class="js-fullheight d-flex justify-content-center align-items-center">
					<div class="col-md-8 text text-center">
						...
						<div class="desc">
							<h2 class="subheading">สวัสดีครับ</h2>
							<h1 class="mb-4">นายอิทธิกร ปิ่นเงิน</h1>
							<p class="mb-4">ผมชอบกินเหล้ากินเบีย ผมนอนตื่นสาย มีแมวชื่อเฉิ่ม ชอบทำตัวเอ๋อๆ</p>
							<p><a href="about.html" class="btn-custom">ดูไรอีกอะ <span class="ion-ios-arrow-forward"></span></a></p>
						</div>
					</div>
				</div>
			</div>
